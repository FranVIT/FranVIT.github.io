<?php
	...
	try {
		...
		$mail->SMTPAuth = true;
		$mail->Username = 'tec.cyd@gmail.com';
		$mail->Password = 'pggkcsijsslervkl';
		$mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;
		$mail->Port = 465;
		
		

		$mail->setFrom('tec.cyd@gmail.com', 'Tecnologico villahermosa'); 
		$mail->addAddress($email, $nombre);
		
		$mail->addAttachment('PHPMailer/Docs/itvh1.jpg');
